...
def NES_search():
  ...
  if search_num == 6:
    ...
    # stats_logging = {'mu': [], 'sigma': [], 'fitness': [], 'entropy':[]}
    # history = []
    # fitness_origin = []
    ...
    #     stats_logging['mu'].append(result[0])
    #     stats_logging['entropy'].append(solver.entropy)
    ...
    print('--------------------------------------------------')
    path = '/users/jgopal/Neurips2023/ViewFool_/resultsMay5/' + args.dataset_name + '/' +  args.scene_name + '/' 
